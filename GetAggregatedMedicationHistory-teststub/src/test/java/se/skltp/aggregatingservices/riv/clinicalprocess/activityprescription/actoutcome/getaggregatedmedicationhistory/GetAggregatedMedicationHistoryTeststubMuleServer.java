...
public class GetAggregatedMedicationHistoryTeststubMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedMedicationHistory-teststub";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedMedicationHistoryTeststubMuleServer.class);
