...
public class GAMHCreateRequestListTest extends CreateFindContentTest {
  ...
  public static void before() {
    configuration = new GAMHAgpServiceConfiguration();
    agpServiceFactory = new GAMHAgpServiceFactoryImpl();
