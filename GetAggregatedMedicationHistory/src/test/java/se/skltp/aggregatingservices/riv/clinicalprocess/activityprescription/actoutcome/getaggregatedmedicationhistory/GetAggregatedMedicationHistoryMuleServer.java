...
public class GetAggregatedMedicationHistoryMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedMedicationHistory";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedMedicationHistoryMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedMedicationHistory-common.xml"
        //
