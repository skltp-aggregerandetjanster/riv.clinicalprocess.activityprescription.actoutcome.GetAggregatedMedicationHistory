...
public class GetAggregatedMedicationHistoryIntegrationTest extends AbstractAggregateIntegrationTest {
    ...
    protected String getConfigResources() {
        ...
        // Only load GetAggregatedMedicationHistory-common.xml, it will import the other config files since mule-deploy.properties can't
        // load config-files from jar-files on the classpath, e.g. agp-core.jar
