...
public class GetAggregatedMedicationHistoryIntegrationTest extends AbstractAggregateIntegrationTest {
    ...
    private static final RecursiveResourceBundle rb = new RecursiveResourceBundle("GetAggregatedMedicationHistory-config");
	private static final String SKLTP_HSA_ID = rb.getString("SKLTP_HSA_ID");

    private static final String LOGICAL_ADDRESS = "logical-address";
	private static final String EXPECTED_ERR_TIMEOUT_MSG = "Read timed out";
	private static final String EXPECTED_ERR_INVALID_ID_MSG = "Invalid Id: " + TEST_RR_ID_FAULT_INVALID_ID;
	private static final String DEFAULT_SERVICE_ADDRESS = GetAggregatedMedicationHistoryMuleServer.getAddress("SERVICE_INBOUND_URL");

	protected String getConfigResources() {
		return 
			"soitoolkit-mule-jms-connector-activemq-embedded.xml," + 
	  		"GetAggregatedMedicationHistory-common.xml," +
//          Only load GetAggregatedMedicationHistory-common.xml, it will import the other config files since mule-deploy.properties can't load config-files from jar-files on the classpath, e.g. agp-core.jar
...
//	        "aggregating-service.xml," +
	...
	private List<ProcessingStatusRecordType> doTest(String registeredResidentId, String senderId, String originalConsumerHsaId, int expectedProcessingStatusSize, ExpectedTestData... testData) {
		...
		GetAggregatedMedicationHistoryTestConsumer consumer = new GetAggregatedMedicationHistoryTestConsumer(DEFAULT_SERVICE_ADDRESS, senderId ,originalConsumerHsaId);
